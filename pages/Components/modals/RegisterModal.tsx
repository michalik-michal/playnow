 ...
 const RegisterModal = () => {
    ...
    const bodyContent = (
        <div className="flex flex-col gap-4">
            <Heading title="Welcome to PlayNow" subtitle="Create an account!"/>
            <Input id="email" label="Email" disabled={isLodaing} register={register} errors={errors} required/>
            <Input id="name" label="Name" disabled={isLodaing} register={register} errors={errors} required/>
    ...
    return (
        <Modal disabled={isLodaing} isOpen={registerModal.isOpen} title="Register" actionLabel="Continue" onClose={registerModal.onClose} onSubmit={handleSubmit(onSubmit)} body={bodyContent} footer={footerContent}/>
    )
 }
